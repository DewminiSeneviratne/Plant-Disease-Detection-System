            ...
            <div className='adminbg' >
                ...
                <div style={{ marginLeft: '350px' }}>
                    ...
                    <button type='submit' style={{ borderRadius: '30px', border: 'none', backgroundColor: '#6bb83b', color: 'white', fontSize: '20px', fontWeight: 'bold', cursor: 'pointer' }}>
                        <a href='/admindiseases' style={{ color: "white", textDecoration: 'none' }}>{<ArowBackIcon />}</a>
                    </button>

                    <p style={{ fontFamily: 'Poppins', fontSize: '40px', fontWeight: 'bold', cursor: 'default' }}>Edit Plant Diseases</p> <br></br>
                </div>


                <div className='adminedit'>
                    <h1 style={{ cursor: 'default' }}>Edit Plant Diseases</h1>
